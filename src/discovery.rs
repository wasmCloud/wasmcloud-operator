use kube::core::{GroupVersionKind, ListMeta, ObjectMeta};
use serde::Serialize;
...
// Based on https://github.com/kubernetes/kubernetes/blob/ec5096fa869b801d6eb1bf019819287ca61edc4d/pkg/apis/apidiscovery/types.go#L25-L37
#[derive(Clone, Debug, Serialize)]
...
impl Default for APIGroupDiscoveryList {
    fn default() -> Self {
        Self {
            api_version: "apidiscovery.k8s.io/v2beta1".to_string(),
...
// Based on https://github.com/kubernetes/kubernetes/blob/ec5096fa869b801d6eb1bf019819287ca61edc4d/pkg/apis/apidiscovery/types.go#L41-L58
#[derive(Clone, Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct APIGroupDiscovery {
    ...
    pub versions: Vec<APIVersionDiscovery>, // `json:"versions,omitempty" protobuf:"bytes,2,rep,name=versions"`
}

/// APIVersionDiscovery holds a list of APIResourceDiscovery types that are served for a particular version within an API Group.
// Based on https://github.com/kubernetes/kubernetes/blob/ec5096fa869b801d6eb1bf019819287ca61edc4d/pkg/apis/apidiscovery/types.go#L60-L77
#[derive(Clone, Debug, Serialize)]
...
// Based on https://github.com/kubernetes/kubernetes/blob/ec5096fa869b801d6eb1bf019819287ca61edc4d/pkg/apis/apidiscovery/types.go#L79-L113
#[derive(Clone, Debug, Serialize)]
#[serde(rename_all = "camelCase")]
...
// Based on https://github.com/kubernetes/kubernetes/blob/ec5096fa869b801d6eb1bf019819287ca61edc4d/pkg/apis/apidiscovery/types.go#L131C1-L156
#[derive(Clone, Debug, Serialize)]
#[serde(rename_all = "camelCase")]
